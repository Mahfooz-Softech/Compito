...
export const ServiceRequestNotifications = () => {
  const { user } = useAuth();
        ...
        .on('postgres_changes', 
          ...
          (payload) => {
            ...
            toast({
              ...
              description: "You have received a new service request. Check your notifications!",
              duration: 5000,
            });
          }
        )
  ...
  const handleStartConversation = async (request: ServiceRequest) => {
    try {
      // Create initial message to start conversation
      const initialMessage = `Hi! I received your request for ${request.service_title}. I'd love to help you with this project. Let me know if you have any questions, and I'll prepare a custom offer for you.`;
      ...
      toast({
        ...
        description: "You can now chat with the customer in your Messages tab.",
      });
...
This is for your ${selectedRequest.service_title} request. Would you like to accept this offer? I'm ready to get started!`;
      ...
      toast({
        title: "Offer Sent!",
        description: "Your offer has been sent to the customer. They can now review and accept it.",
      });
      ...
      {requests.length === 0 ? (
        ...
        <div className="grid gap-6">
          {requests.map((request) => (
            <Card key={request.id} className="border-gradient hover:shadow-lg transition-shadow animate-in fade-in-50">
